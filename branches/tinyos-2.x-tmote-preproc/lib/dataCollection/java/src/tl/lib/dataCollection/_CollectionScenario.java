 ...
 * *
 * *	$Id: _CollectionScenario.java 684 2008-10-01 10:07:49Z mceriotti $
 * *
...
public interface _CollectionScenario {
	...
	public Vector<_CollectionFeatureListener> getSampleFeatureListeners(_CollectionFeature feature);

	public _CollectionSourceDescriptor getSourceDescriptor();

	public void setSerial(SerialComm sender);
