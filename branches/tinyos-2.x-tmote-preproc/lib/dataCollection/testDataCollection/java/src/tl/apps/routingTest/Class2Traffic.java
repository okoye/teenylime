 ...
 * *
 * *	$Id: Class2Traffic.java 785 2009-04-29 10:50:15Z mceriotti $
 * *
...
public class Class2Traffic implements _CollectionFeatureListener {

	private static _CollectionFeature feature = null;

	private String fileName;

	public Class2Traffic(String dir) {
		feature = new FeatureTest(FeatureTest.CLASS_2, "Class2");
		this.fileName = "";
		if (dir.length() > 0) {
