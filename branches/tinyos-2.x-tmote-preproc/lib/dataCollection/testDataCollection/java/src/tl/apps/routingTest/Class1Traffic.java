 ...
 * *
 * *	$Id: Class1Traffic.java 785 2009-04-29 10:50:15Z mceriotti $
 * *
...
public class Class1Traffic implements _CollectionFeatureListener {

	private static _CollectionFeature feature = null;

	private String fileName;

	public Class1Traffic(String dir) {
		feature = new FeatureTest(FeatureTest.CLASS_1, "Class1");
		this.fileName = "";
		if (dir.length() > 0) {
