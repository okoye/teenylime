 ...
 * * DATE
 * *    $LastChangedDate: 2009-12-07 15:34:15 -0600 (Mon, 07 Dec 2009) $
 * * LAST_CHANGE_BY
 * *    $LastChangedBy: mceriotti $
 * *
 * *	$Id: GlobalTime.nc 992 2009-12-07 21:34:15Z mceriotti $
 * *
...
interface GlobalTime{ 
   ...
   */
  async command uint16_t getGlobalTime();
   ...
   *
   */
  async event void timeEvent();	
  
   /**
   * Start the Synchronization protocol   
   */
  async command void startSync();  
}
