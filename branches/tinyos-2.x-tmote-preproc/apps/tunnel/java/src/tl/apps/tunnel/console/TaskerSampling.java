 ...
 * * DATE
 * *    $LastChangedDate: 2010-01-14 05:00:12 -0600 (Thu, 14 Jan 2010) $
 * * LAST_CHANGE_BY
 * *    $LastChangedBy: mceriotti $
 * *
 * *	$Id: TaskerSampling.java 1024 2010-01-14 11:00:12Z mceriotti $
 * *
...
public class TaskerSampling implements _ConsoleDisseminator {

	private BufferedReader reader;

	public TaskerSampling() {
	...
	public String description() {
		return "Change the Operating Parameters";
	}
	...
	public Vector<Tuple> getTuples() throws IllegalArgumentException {
		...
		System.out.println("Insert the Omega filtering parameter");
		try {
			o = Integer.parseInt(reader.readLine());
		} catch (Exception e) {
			throw new IllegalArgumentException(e);
		}
		System.out.println("Insert the Alpha filtering parameter");
		try {
