 ...
 * * DATE
 * *    $LastChangedDate: 2009-03-28 07:34:16 -0500 (Sat, 28 Mar 2009) $
 * * LAST_CHANGE_BY
 * *    $LastChangedBy: mceriotti $
 * *
 * *	$Id: Battery.java 759 2009-03-28 12:34:16Z mceriotti $
 * *
...
public class Battery implements _CollectionFeatureListener {
	...
	public Battery(String dir, boolean gui) {
		feature = new TunnelFeature(TunnelFeature.BATTERY, "Battery");
		this.fileName = "";
		if (dir.length() > 0) {
