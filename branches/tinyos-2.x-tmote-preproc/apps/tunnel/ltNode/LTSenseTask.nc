 ...
 * *    TeenyLIME
 * * VERSION
 * *    $LastChangedRevision: 919 $
 * * DATE
 * *    $LastChangedDate: 2009-10-21 09:08:17 -0500 (Wed, 21 Oct 2009) $
 * * LAST_CHANGE_BY
 * *    $LastChangedBy: mceriotti $
 * *
 * *	$Id: LTSenseTask.nc 919 2009-10-21 14:08:17Z mceriotti $
 * *
...
implementation {
  ...
  void processData() {
    ...
    tuple<uint8_t, uint16_t, uint16_t, 
      uint8_t[TUPLE_MSG_PAYLOAD_SIZE]> ltReading;
    ...
    if (fw_active) {
      call TS.out(&outId, FALSE, TL_LOCAL, RAM_TS, (tuple *) &ltReading);    
    } else {
      msgSeqNum--;
    }
  }
