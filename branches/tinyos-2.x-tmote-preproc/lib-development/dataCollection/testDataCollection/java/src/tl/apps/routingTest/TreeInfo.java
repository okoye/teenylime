 ...
 * *
 * *	$Id: TreeInfo.java 913 2009-10-15 21:26:44Z mceriotti $
 * *
...
public class TreeInfo implements _CollectionFeatureListener {
	...
	public void receivedSample(SourceId sourceId, Sample sample) {
		...
		try {
			...
			writer.write("\tGATEWAY: " + sampleValue.get(0));
			writer.write("\tPARENT: " + sampleValue.get(1));
			writer.write("\tPATHCOST: " + sampleValue.get(2));
	...
	public static Vector<Integer> convert(int gateway, int parent, int pathCost) {
		Vector<Integer> ret = new Vector<Integer>();
		ret.add(new Integer(gateway));
