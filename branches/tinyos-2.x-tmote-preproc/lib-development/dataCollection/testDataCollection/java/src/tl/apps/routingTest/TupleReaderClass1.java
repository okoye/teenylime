 ...
 * *
 * *	$Id: TupleReaderClass1.java 918 2009-10-20 15:31:11Z mceriotti $
 * *
...
public class TupleReaderClass1 implements _CollectionTupleReader {
	private FileWriter writer;
	private String fileName = "class1.txt";
	private boolean log;

	public TupleReaderClass1() {
		this.log = false;
	}
	...
	public Hashtable<_CollectionFeature, Sample> read(Tuple tuple) {
		...
		if (((data[0] << 8) + data[1]) == Constants.CLASS_1_END_SESSION) {
			ending = true;
		}
		...
		ret.put(Class1Traffic.getFeature(), new Sample(sample, period,
