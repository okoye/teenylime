...
implementation {
  ...
  void tune(tuple<uint8_t, uint8_t, uint16_t, uint16_t,
    ...
    call Tuning.setImmediate(KEY_LOCAL_LPL_SLEEP, taskTuple->value2);
    call Tuning.setImmediate(KEY_REMOTE_LPL_SLEEP, taskTuple->value2);
    call Tuning.setImmediate(KEY_REMOTE_OP_TIMEOUT, 2*taskTuple->value2 + 50);
    call CollectionTuning.setImmediate(KEY_CACHE_SIZE, taskTuple->value3);
    ...
    call CollectionTuning.setImmediate(KEY_LPL_RELIABLE_PATH,
                                       taskTuple->value5);
#ifdef PRINTF_SUPPORT
    printf ("TUNL%uC%uR%uL%u\n", taskTuple->value2, taskTuple->value3,
            taskTuple->value4, taskTuple->value5);
