 ...
 * * DATE
 * *    $LastChangedDate: 2010-01-11 02:11:12 -0600 (Mon, 11 Jan 2010) $
 * * LAST_CHANGE_BY
 * *    $LastChangedBy: mceriotti $
 * *
 * *	$Id: TreeBuilderC.nc 1014 2010-01-11 08:11:12Z mceriotti $
 * *
...
implementation {
  ...
  void buildTree(){
    ...
    t = newTuple(
                 ...
                 actualField(3*rebuilding_period/2),
                 actualField(TL_LOCAL),
                 actualField(0));
  ...
  command void TreeConnection.congested(){
    tuple<uint8_t, uint16_t, uint16_t, uint16_t, uint16_t, uint16_t>  t;
    t = newTuple(actualField(DATA_COLLECT_CTRL_TYPE),
                 actualField(TL_LOCAL),
                 actualField(0xFFFF),
                 actualField(3*rebuilding_period/2),
                 actualField(TL_LOCAL),
