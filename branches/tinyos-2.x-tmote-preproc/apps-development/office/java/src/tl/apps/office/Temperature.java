 ...
 * *
 * *	$Id: Temperature.java 883 2009-07-14 12:51:17Z mceriotti $
 * *
...
public class Temperature implements _CollectionFeatureListener {
	...
	public Temperature(String dir, boolean gui) {
		feature = new FeatureOffice(FeatureOffice.TEMPERATURE, "Temperature");
		this.fileName = "";
		if (dir.length() > 0) {
	...
	public static _CollectionFeature getFeature() {
		if (feature == null)
			feature = new FeatureOffice(FeatureOffice.TEMPERATURE,
					"Temperature");
		return feature;
	}
	...
	public static Vector<Double> convert(int rawValue) {
		...
		double temperature = (-39.60 + 0.01 * (double) rawValue);
