 ...
 * *
 * *	$Id: TaskerSynthLight.java 883 2009-07-14 12:51:17Z mceriotti $
 * *
...
public class TaskerSynthLight implements _ConsoleDisseminator {

	private BufferedReader reader;

	public TaskerSynthLight() {
	...
	public Tuple getTuple() throws IllegalArgumentException {
		...
		System.out.println("SYNTH LIGHT TASK DEFINITION");
		...
		content.add(new Field().actualField(new Uint8(Constants.SYNTH_LIGHT)));
		...
		envelope
				.add(new Field().actualField(new Uint16(Constants.SYNTH_LIGHT)));
