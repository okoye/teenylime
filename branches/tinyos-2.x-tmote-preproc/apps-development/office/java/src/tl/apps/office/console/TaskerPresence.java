 ...
 * *
 * *	$Id: TaskerPresence.java 883 2009-07-14 12:51:17Z mceriotti $
 * *
...
public class TaskerPresence implements _ConsoleDisseminator {

	private BufferedReader reader;

	public TaskerPresence() {
	...
	public Tuple getTuple() throws IllegalArgumentException {
		...
		System.out.println("PRESENCE TASK DEFINITION");
		...
		content.add(new Field().actualField(new Uint8(Constants.PRESENCE)));
		...
		envelope.add(new Field().actualField(new Uint16(Constants.PRESENCE)));
