 ...
 * *
 * *	$Id: TaskerMagnetic.java 883 2009-07-14 12:51:17Z mceriotti $
 * *
...
public class TaskerMagnetic implements _ConsoleDisseminator {

	private BufferedReader reader;

	public TaskerMagnetic() {
	...
	public Tuple getTuple() throws IllegalArgumentException {
		...
		System.out.println("MAGNETIC TASK DEFINITION");
		...
		content.add(new Field().actualField(new Uint8(Constants.MAGNETIC)));
		...
		envelope.add(new Field().actualField(new Uint16(Constants.MAGNETIC)));
