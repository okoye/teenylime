 ...
 * *
 * *	$Id: Dust.java 883 2009-07-14 12:51:17Z mceriotti $
 * *
...
public class Dust implements _CollectionFeatureListener {
	...
	public Dust(boolean gui) {
		this.gui = gui;
		this.console = false;
	}

	public Dust(String dir, boolean gui) {
		feature = new FeatureOffice(FeatureOffice.DUST, "DUST");
		this.fileName = "";
		if (dir.length() > 0) {
	...
	public static _ChartPanel getChartPanel(_CollectionGUIScenario scenario) {
		if (panel == null)
			panel = new TimeSeriesChart(scenario, "Dust", "Dust", "Raw Value");
		return panel;
	}
