 ...
 * *
 * *	$Id: TaskerPressure.java 883 2009-07-14 12:51:17Z mceriotti $
 * *
...
public class TaskerPressure implements _ConsoleDisseminator {

	private BufferedReader reader;

	public TaskerPressure() {
	...
	public Tuple getTuple() throws IllegalArgumentException {
		...
		System.out.println("PRESSURE TASK DEFINITION");
		...
		content.add(new Field().actualField(new Uint8(Constants.PRESSURE)));
		...
		envelope.add(new Field().actualField(new Uint16(Constants.PRESSURE)));
