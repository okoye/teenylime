 ...
 * *
 * *	$Id: TaskerSolarLight.java 883 2009-07-14 12:51:17Z mceriotti $
 * *
...
public class TaskerSolarLight implements _ConsoleDisseminator {

	private BufferedReader reader;

	public TaskerSolarLight() {
	...
	public Tuple getTuple() throws IllegalArgumentException {
		...
		System.out.println("SOLAR LIGHT TASK DEFINITION");
		...
		content.add(new Field().actualField(new Uint8(Constants.SOLAR_LIGHT)));
		...
		envelope
				.add(new Field().actualField(new Uint16(Constants.SOLAR_LIGHT)));
