 ...
 * *
 * *	$Id: TaskerCO2.java 883 2009-07-14 12:51:17Z mceriotti $
 * *
...
public class TaskerCO2 implements _ConsoleDisseminator {
	...
	public Tuple getTuple() throws IllegalArgumentException {
		...
		System.out.println("CO2 TASK DEFINITION");
		...
		content.add(new Field().actualField(new Uint8(Constants.CO2)));
		...
		envelope.add(new Field().actualField(new Uint16(Constants.CO2)));
