 ...
 * *
 * *	$Id: Humidity.java 883 2009-07-14 12:51:17Z mceriotti $
 * *
...
public class Humidity implements _CollectionFeatureListener {
	...
	public Humidity(String dir, boolean gui) {
		feature = new FeatureOffice(FeatureOffice.HUMIDITY, "Humidity");
		this.fileName = "";
		if (dir.length() > 0) {
	...
	public static Vector<Double> convert(int rawValue) {
		...
		double humidity = (-4.0 + 0.0405 * (double) rawValue - 0.0000028 * (rawValue * rawValue));
