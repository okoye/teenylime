 ...
 * *
 * *	$Id: TaskerTilt.java 883 2009-07-14 12:51:17Z mceriotti $
 * *
...
public class TaskerTilt implements _ConsoleDisseminator {
	...
	public Tuple getTuple() throws IllegalArgumentException {
		...
		System.out.println("TILT TASK DEFINITION");
		...
		content.add(new Field().actualField(new Uint8(Constants.TILT)));
		...
		envelope.add(new Field().actualField(new Uint16(Constants.TILT)));
