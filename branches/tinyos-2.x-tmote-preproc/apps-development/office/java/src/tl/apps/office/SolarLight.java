 ...
 * *
 * *	$Id: SolarLight.java 883 2009-07-14 12:51:17Z mceriotti $
 * *
...
public class SolarLight implements _CollectionFeatureListener {
	...
	public SolarLight(String dir, boolean gui) {
		feature = new FeatureOffice(FeatureOffice.SOLAR_LIGHT, "SolarLight");
		this.fileName = "";
		if (dir.length() > 0) {
	...
	public static _ChartPanel getChartPanel(_CollectionGUIScenario scenario) {
		if (panel == null)
			panel = new TimeSeriesChart(scenario, "SolarLight", "Solar Light", "lx");
		return panel;
	}

	public static Vector<Double> convert(int rawValue) {
		Vector<Double> ret = new Vector<Double>();
		double solarLight = (((double) rawValue / 4096 * 1.5) / 100) * 1e5;
