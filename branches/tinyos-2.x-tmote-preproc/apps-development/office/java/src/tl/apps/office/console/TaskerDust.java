 ...
 * *
 * *	$Id: TaskerDust.java 883 2009-07-14 12:51:17Z mceriotti $
 * *
...
public class TaskerDust implements _ConsoleDisseminator {
	...
	public Tuple getTuple() throws IllegalArgumentException {
		...
		System.out.println("DUST TASK DEFINITION");
		...
		content.add(new Field().actualField(new Uint8(Constants.DUST)));
		...
		envelope.add(new Field().actualField(new Uint16(Constants.DUST)));
