 ...
 * *
 * *	$Id: TaskerMicrophone.java 883 2009-07-14 12:51:17Z mceriotti $
 * *
...
public class TaskerMicrophone implements _ConsoleDisseminator {

	private BufferedReader reader;

	public TaskerMicrophone() {
	...
	public Tuple getTuple() throws IllegalArgumentException {
		...
		System.out.println("MICROPHONE TASK DEFINITION");
		...
		content.add(new Field().actualField(new Uint8(Constants.MICROPHONE)));
		...
		envelope.add(new Field().actualField(new Uint16(Constants.MICROPHONE)));
