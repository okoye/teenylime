 ...
 * *
 * *	$Id: TaskerHumidity.java 883 2009-07-14 12:51:17Z mceriotti $
 * *
...
public class TaskerHumidity implements _ConsoleDisseminator {

	private BufferedReader reader;

	public TaskerHumidity() {
	...
	public Tuple getTuple() throws IllegalArgumentException {
		...
		System.out.println("HUMIDITY TASK DEFINITION");
		...
		content.add(new Field().actualField(new Uint8(Constants.HUMIDITY)));
		...
		envelope.add(new Field().actualField(new Uint16(Constants.HUMIDITY)));
