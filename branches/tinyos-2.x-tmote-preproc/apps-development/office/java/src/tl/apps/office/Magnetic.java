 ...
 * *
 * *	$Id: Magnetic.java 883 2009-07-14 12:51:17Z mceriotti $
 * *
...
public class Magnetic implements _CollectionFeatureListener {
	...
	public Magnetic(boolean gui) {
		this.gui = gui;
		this.console = false;
	}

	public Magnetic(String dir, boolean gui) {
		feature = new FeatureOffice(FeatureOffice.MAGNETIC, "MAGNETIC");
		this.fileName = "";
		if (dir.length() > 0) {
	...
	public static _ChartPanel getChartPanel(_CollectionGUIScenario scenario) {
		if (panel == null)
			panel = new TimeSeriesChart(scenario, "Magnetic", "Magnetic", "Raw Value");
		return panel;
	}
