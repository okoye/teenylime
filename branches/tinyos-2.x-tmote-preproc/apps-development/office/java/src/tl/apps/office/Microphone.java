 ...
 * *
 * *	$Id: Microphone.java 883 2009-07-14 12:51:17Z mceriotti $
 * *
...
public class Microphone implements _CollectionFeatureListener {
	...
	public Microphone(boolean gui) {
		this.gui = gui;
		this.console = false;
	}

	public Microphone(String dir, boolean gui) {
		feature = new FeatureOffice(FeatureOffice.MICROPHONE, "Microphone");
		this.fileName = "";
		if (dir.length() > 0) {
	...
	public static _ChartPanel getChartPanel(_CollectionGUIScenario scenario) {
		if (panel == null)
			panel = new TimeSeriesChart(scenario, "Microphone", "Microphone", "Raw Value");
		return panel;
	}
