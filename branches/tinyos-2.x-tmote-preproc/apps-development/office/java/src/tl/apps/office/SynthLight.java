 ...
 * *
 * *	$Id: SynthLight.java 883 2009-07-14 12:51:17Z mceriotti $
 * *
...
public class SynthLight implements _CollectionFeatureListener {
	...
	public SynthLight(String dir, boolean gui) {
		feature = new FeatureOffice(FeatureOffice.SYNTH_LIGHT, "SynthLight");
		this.fileName = "";
		if (dir.length() > 0) {
	...
	public static _ChartPanel getChartPanel(_CollectionGUIScenario scenario) {
		if (panel == null)
			panel = new TimeSeriesChart(scenario, "SynthLight", "SynthLight", "lx");
		return panel;
	}

	public static Vector<Double> convert(int rawValue) {
		Vector<Double> ret = new Vector<Double>();
		double synthLight = (((double) rawValue / 4096 * 2.5) / 100) * 0.625 * 1e6;
