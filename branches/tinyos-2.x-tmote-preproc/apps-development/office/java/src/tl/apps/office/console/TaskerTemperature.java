 ...
 * *
 * *	$Id: TaskerTemperature.java 883 2009-07-14 12:51:17Z mceriotti $
 * *
...
public class TaskerTemperature implements _ConsoleDisseminator {

	private BufferedReader reader;

	public TaskerTemperature() {
	...
	public Tuple getTuple() throws IllegalArgumentException {
		...
		System.out.println("TEMPERATURE TASK DEFINITION");
		...
		content.add(new Field().actualField(new Uint8(Constants.TEMPERATURE)));
		...
		envelope
				.add(new Field().actualField(new Uint16(Constants.TEMPERATURE)));
