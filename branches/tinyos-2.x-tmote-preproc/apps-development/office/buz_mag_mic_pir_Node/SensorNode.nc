...
/*   components NoLedsC as LedsC; */
  ...
  components BuzSampler, MagSampler, MicSampler, PirSampler;
  ...
  // Sampler wirings
  BuzSampler.Boot -> MainC.Boot;
  BuzSampler.TS -> TeenyLimeC.TupleSpace[unique("TL")];
  BuzSampler.GlobalTime -> TimeSyncC;
#ifdef PRINTF_SUPPORT
  BuzSampler.PrintfControl -> PrintfC;
  BuzSampler.PrintfFlush -> PrintfC;
#endif

  // Sampler wirings
  MagSampler.Boot -> MainC.Boot;
  MagSampler.TS -> TeenyLimeC.TupleSpace[unique("TL")];
  MagSampler.CollectionInfo -> DataCollection;
  MagSampler.GlobalTime -> TimeSyncC;
#ifdef PRINTF_SUPPORT
  MagSampler.PrintfControl -> PrintfC;
  MagSampler.PrintfFlush -> PrintfC;
#endif

  // Sampler wirings
  MicSampler.Boot -> MainC.Boot;
  MicSampler.TS -> TeenyLimeC.TupleSpace[unique("TL")];
  MicSampler.CollectionInfo -> DataCollection;
  MicSampler.GlobalTime -> TimeSyncC;
#ifdef PRINTF_SUPPORT
  MicSampler.PrintfControl -> PrintfC;
  MicSampler.PrintfFlush -> PrintfC;
#endif

  // Sampler wirings
  PirSampler.Boot -> MainC.Boot;
  PirSampler.TS -> TeenyLimeC.TupleSpace[unique("TL")];
  PirSampler.CollectionInfo -> DataCollection;
  PirSampler.GlobalTime -> TimeSyncC;
#ifdef PRINTF_SUPPORT
  PirSampler.PrintfControl -> PrintfC;
  PirSampler.PrintfFlush -> PrintfC;
#endif
