 ...
 * *
 * *	$Id: TiltSampler.nc 883 2009-07-14 12:51:17Z mceriotti $
 * *
...
implementation {
  ...
  components LedsC;
  components TiltSenseTask as SenseTask;
  ...
  SenseTask.SensorX -> CO1000C.ReadTiltX;
  SenseTask.SensorY -> CO1000C.ReadTiltY;
