...
/*   components NoLedsC as LedsC; */
  ...
  components AccelSampler, ForceSampler, TiltSampler;
  ...
  // Sampler wirings
  ForceSampler.Boot -> MainC.Boot;
  ForceSampler.TS -> TeenyLimeC.TupleSpace[unique("TL")];
  ForceSampler.CollectionInfo -> DataCollection;
  ForceSampler.GlobalTime -> TimeSyncC;
#ifdef PRINTF_SUPPORT
  ForceSampler.PrintfControl -> PrintfC;
  ForceSampler.PrintfFlush -> PrintfC;
#endif

  // Sampler wirings
  TiltSampler.Boot -> MainC.Boot;
  TiltSampler.TS -> TeenyLimeC.TupleSpace[unique("TL")];
  TiltSampler.CollectionInfo -> DataCollection;
  TiltSampler.GlobalTime -> TimeSyncC;
#ifdef PRINTF_SUPPORT
  TiltSampler.PrintfControl -> PrintfC;
  TiltSampler.PrintfFlush -> PrintfC;
#endif
