 ...
 * *
 * *	$Id: AccelSampler.nc 883 2009-07-14 12:51:17Z mceriotti $
 * *
...
implementation {
  ...
  components LedsC;
  components AccelSenseTask as SenseTask;
  ...
  SenseTask.SensorX -> CO1000C.ReadAccelX;
  SenseTask.SensorY -> CO1000C.ReadAccelY;
