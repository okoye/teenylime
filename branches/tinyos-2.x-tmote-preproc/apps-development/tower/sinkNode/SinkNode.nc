 ...
 * *
 * *	$Id: SinkNode.nc 300 2008-02-26 19:50:56Z mceriotti $
 * *
...
implementation {
  ...
  TupleGateway.TimerWaitDisseminate -> TimerWD;
  TupleGateway.TimerWaitSynch -> TimerWS;
  TupleGateway.CollectionInfo -> DataCollection.CollectionInfo;
