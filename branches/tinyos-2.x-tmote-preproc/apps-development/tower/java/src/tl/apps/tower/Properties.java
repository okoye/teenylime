 ...
 * * DATE
 * *    $LastChangedDate: 2009-12-03 01:13:49 -0600 (Thu, 03 Dec 2009) $
 * * LAST_CHANGE_BY
 * *    $LastChangedBy: mceriotti $
 * *
 * *	$Id: Properties.java 981 2009-12-03 07:13:49Z mceriotti $
 * *
...
public class Properties {
	...
	public final static int TUPLE_DISS_PAYLOAD_SIZE = 44;
	public final static int TUPLE_MSG_PAYLOAD_SIZE = 44;
	...
	static final int PRIMARY_X_144 = 296;
	static final int PRIMARY_Y_144 = 800;
	...
	static final int PRIMARY_X_160 = 377;
	static final int PRIMARY_Y_160 = 268;
	static final int PRIMARY_X_161 = 273;
	static final int PRIMARY_Y_161 = 763;
	static final int PRIMARY_X_162 = 567;
	static final int PRIMARY_Y_162 = 580;
	static final int PRIMARY_X_163 = 240;
	static final int PRIMARY_Y_163 = 394;
	...
	static final int SECONDARY_X_144 = 903;
	static final int SECONDARY_Y_144 = 750;
	...
	static final int SECONDARY_X_160 = 932;
	static final int SECONDARY_Y_160 = 210;
	static final int SECONDARY_X_161 = 908;
	static final int SECONDARY_Y_161 = 517;
	static final int SECONDARY_X_162 = 908;
	static final int SECONDARY_Y_162 = 417;
	static final int SECONDARY_X_163 = 831;
	static final int SECONDARY_Y_163 = 210;
	...
	static final Color COLOR_143 = new Color(250, 125, 0);
	...
	static final Color COLOR_153 = new Color(0, 0, 90);
	...
	public static int initialPrimaryXPosition(SourceId identifier) {
		...
		case 154:
			...
			break;
		case 160:
			result = PRIMARY_X_160;
			break;
		case 161:
			result = PRIMARY_X_161;
			break;
		case 162:
			result = PRIMARY_X_162;
			break;
		case 163:
			result = PRIMARY_X_163;
			break;
		default:
	...
	public static int initialPrimaryYPosition(SourceId identifier) {
		...
		case 154:
			...
			break;
		case 160:
			result = PRIMARY_Y_160;
			break;
		case 161:
			result = PRIMARY_Y_161;
			break;
		case 162:
			result = PRIMARY_Y_162;
			break;
		case 163:
			result = PRIMARY_Y_163;
			break;
		default:
	...
	public static int initialSecondaryXPosition(SourceId identifier) {
		...
		case 154:
			...
			break;
		case 160:
			result = SECONDARY_X_160;
			break;
		case 161:
			result = SECONDARY_X_161;
			break;
		case 162:
			result = SECONDARY_X_162;
			break;
		case 163:
			result = SECONDARY_X_163;
			break;
		default:
	...
	public static int initialSecondaryYPosition(SourceId identifier) {
		...
		case 154:
			...
			break;
		case 160:
			result = SECONDARY_Y_160;
			break;
		case 161:
			result = SECONDARY_Y_161;
			break;
		case 162:
			result = SECONDARY_Y_162;
			break;
		case 163:
			result = SECONDARY_Y_163;
			break;
		default:
			result = (int) (Math.random() * Y_MAX);
		}
