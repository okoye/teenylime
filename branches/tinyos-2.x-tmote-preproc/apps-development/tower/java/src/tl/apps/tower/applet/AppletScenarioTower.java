 ...
 * *
 * *	$Id: AppletScenarioTower.java 975 2009-12-03 06:55:45Z mceriotti $
 * *
...
public class AppletScenarioTower implements _CollectionGUIScenario,
	...
	public AppletScenarioTower(AppletManager appletManager) {
		...
		this.sourceDescriptor = new AppletSourceDescriptorTower();
	...
	public Source createSource(SourceId id) {
		...
		return new AppletSourceTower(id, id.equals(sinkId), Battery
				.getFeature(), TreeInfo.getFeature());
	}
	...
	public Vector<_GUIDisseminator> getDisseminators() {
		return new Vector<_GUIDisseminator>();
	}
