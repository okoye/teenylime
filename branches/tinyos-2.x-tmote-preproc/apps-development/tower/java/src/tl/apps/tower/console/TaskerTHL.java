 ...
 * *
 * *	$Id: TaskerTHL.java 980 2009-12-03 07:11:16Z mceriotti $
 * *
...
public class TaskerTHL implements _ConsoleDisseminator {
	...
	public Vector<Tuple> getTuples() throws IllegalArgumentException {
		...
		System.out.println("TEMPERATURE/HUMIDITY/LIGHT TASK DEFINITION");
		...
		content.add(new Field().actualField(new Uint8(Constants.THL_TASK)));
		...
		envelope.add(new Field().actualField(new Uint16(Constants.THL_TASK)));
