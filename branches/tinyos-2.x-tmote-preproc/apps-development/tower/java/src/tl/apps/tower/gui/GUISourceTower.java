 ...
 * *
 * *	$Id: GUISourceTower.java 845 2009-05-20 13:51:51Z mceriotti $
 * *
...
public class GUISourceTower extends SourceTower {

	private Vector<Point> locations;
	private Color color;

	public GUISourceTower(SourceId identifier, boolean sink, _CollectionFeature battery,
