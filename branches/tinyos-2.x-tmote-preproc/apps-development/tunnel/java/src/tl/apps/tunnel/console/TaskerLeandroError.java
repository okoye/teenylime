 ...
 * *
 * *	$Id: TaskerLeandroError.java 980 2009-12-03 07:11:16Z mceriotti $
 * *
...
public class TaskerLeandroError implements _ConsoleDisseminator {

	private BufferedReader reader;

	public TaskerLeandroError() {
	...
	public Vector<Tuple> getTuples() throws IllegalArgumentException {
		...
		System.out.println("Insert which test to load (from 0 to 7)");
		try {
			do {
