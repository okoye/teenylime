 ...
 * *    TeenyLIME
 * * VERSION
 * *    $LastChangedRevision: 956 $
 * * DATE
 * *    $LastChangedDate: 2009-11-28 16:11:11 -0600 (Sat, 28 Nov 2009) $
 * * LAST_CHANGE_BY
 * *    $LastChangedBy: mceriotti $
 * *
 * *	$Id: LTNode.nc 956 2009-11-28 22:11:11Z mceriotti $
 * *
...
implementation {
  ...
  components LedsC as siLedsC;
  components NoLedsC as noLedsC; 
...
/*   components FakeDataDisseminationLT as DataDissemination; */
  ...
  SystemMonitor.SystemMonitorCtrl <- LTSampler.SystemMonitorCtrl;
#ifdef PRINTF_SUPPORT
  ...
  DataDissemination.Leds -> noLedsC;
