 ...
 * *
 * *	$Id: LogMySqlManager.java 262 2008-02-02 11:00:33Z mceriotti $
 * *
...
/**
 * The Class LogMySqlManager.
 * 
 * This class writes into a MySql database the information read from a log.
 * 
 * @author Matteo Ceriotti <a href="mailto:ceriotti@fbk.eu">ceriotti@fbk.eu</a>
 */

class LogMySqlManager implements LogManager {
	...
	void connect() {
      ...
      String url = "jdbc:mysql://" + Properties.HOST + ":"
