 ...
 * *
 * *	$Id: SmokeSensor.nc 1 2007-04-27 14:33:25Z lmottola $
 * *
...
/**
 * Smoke sampler for the HVAC application.
 * 
 * @author Luca Mottola 
...
implementation {
  ...
  command result_t StdControl.start() {
    ...
    capSmoke = newCapabilityTuple(2, 
				  actualField_uint16(SMOKE_READING), 
				  formalField(TYPE_UINT16_T));
    call TS.out(FALSE, TL_LOCAL, &capSmoke);
    return SUCCESS;
  }

  command result_t StdControl.stop() {
  
    call TS.in(FALSE, TL_LOCAL, &capSmoke);
    return SUCCESS;
  }
